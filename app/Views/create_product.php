    ...
    <div id="menu" class="menu-main pad-top-100 pad-bottom-100">
        <div class="container">
            <div class="row">
                ...
                <form id="" method="post" class="reservations-box" action="product" enctype="multipart/form-data">

                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <h2 class="text-warning h3 text-center">Nombre</h2>
                        <div class="form-box">
                            <input type="text" name="name" placeholder="Gina" required="required"
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="form-box">
                            <input type="number" name="price" placeholder="3000" required="required"
                                data-error="username is required.">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="reserve-book-btn text-center">
                            <button class="hvr-underline-from-center" type="submit" value="SEND" id="submit">Agregar
                                plato</button>
                        </div>
                    </div>
                    <!-- end col -->
