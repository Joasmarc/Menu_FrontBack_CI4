...
<body background="assets/images/642b74e35250816a878a3aefb6848a81.jpg">
    ...
    <div id="menu" class="menu-main pad-top-100 pad-bottom-100">
        <div class="container">
            <div class="row">
                <div class="text-warning h2 text-center">Inicio de Sesion</div>
                <!-- <form id="contact-form" method="post" class="reservations-box" action="admin"> -->
                <form id="" method="post" class="reservations-box" action="admin">

                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="form-box">
                            <input type="text" name="username" placeholder="Usuario" required="required"
                                data-error="username is required." style="height: 60ox; padding: 10px;">
                        </div>
                    </div>
                    <!-- end col -->
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
